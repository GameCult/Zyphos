# Turtledove Path Dependency

## Sources

- [The Road Not Taken overview](https://en.wikipedia.org/wiki/The_Road_Not_Taken_(short_story))
- [Harry Turtledove short fiction bibliography](https://www.sfsite.com/~silverag/turtledove.html)

## Useful Pressure

Harry Turtledove's "The Road Not Taken" is useful as a path-dependency reference: a species or civilization may discover one powerful technology early, then develop around it so completely that other forms of advancement remain stunted or invisible.
